...
public class fbloginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Password = (EditText)findViewById(R.id.etppp);
...
// ...
    ...
    private void validate(String userUsername, String userPassword){
        if((userUsername.equals("Harish")) && (userPassword.equals("5566"))){
            Intent intent = new Intent(fbloginActivity.this, FirebaseActivity.class);
    ...
    private void updateUI() {
        ...
        Toast.makeText(fbloginActivity.this, "You are Logged in", Toast.LENGTH_LONG).show();

        Intent accountIntent = new Intent(fbloginActivity.this, FirebaseActivity.class);
